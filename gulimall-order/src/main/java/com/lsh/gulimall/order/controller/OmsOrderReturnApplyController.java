...
import com.lsh.gulimall.order.entity.OmsOrderReturnApplyEntity;
import com.lsh.gulimall.order.service.OmsOrderReturnApplyService;
...
public class OmsOrderReturnApplyController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("generator:omsorderreturnapply:list")
    ...
    @RequiresPermissions("generator:omsorderreturnapply:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("generator:omsorderreturnapply:save")
    ...
    @RequiresPermissions("generator:omsorderreturnapply:update")
    ...
    @RequiresPermissions("generator:omsorderreturnapply:delete")
