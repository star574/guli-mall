...
public class OmsRefundInfoController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("generator:omsrefundinfo:list")
    ...
    @RequiresPermissions("generator:omsrefundinfo:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("generator:omsrefundinfo:save")
    ...
    @RequiresPermissions("generator:omsrefundinfo:update")
    ...
    @RequiresPermissions("generator:omsrefundinfo:delete")
