...
public class MyRabbitConfig {
	...
	public Queue stockDelayQueue() {
		...
		/*死信队列配置*/
		map.put("x-dead-letter-exchange", "stock-event-exchange"); //死信交换机
		map.put("x-dead-letter-routing-key", "stock.release"); //路由键
		/*死信过期时间*/
		map.put("x-message-ttl", 120000); //过期时间 2分钟
